...
@class ColorBackgroundView, ComposeBackEnd, ComposeStatusView, DeliveryFailure, EditingMessageWebView, EditingWebMessageController, HeadersEditor, LoadingOverlay, MCAttachment, NSArray, NSButton, NSDictionary, NSMutableArray, NSMutableDictionary, NSOperation, NSOperationQueue, NSStackView, NSString, NSTextField, NSTextFinder, NSView, NSTextFinderBarContainer, NSWindow, StationerySelector, WebArchive, WebViewEditor, _ControllerTitleTransformer;
