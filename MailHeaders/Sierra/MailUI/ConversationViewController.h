...
@interface ConversationViewController : NSViewController <MUICollectionViewDelegate, NSUserInterfaceValidations>
{
    ...
    SubjectHeaderViewController *_subjectHeaderViewController;
...
- (id)viewIndexesForConversationMemberIndexes:(id)arg1;
- (id)conversationMemberIndexesForViewIndexes:(id)arg1;
- (unsigned long long)viewIndexForConversationMemberIndex:(unsigned long long)arg1;
- (unsigned long long)conversationMemberIndexForViewIndex:(unsigned long long)arg1;
